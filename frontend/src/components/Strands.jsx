  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uWaviness: { value: waviness }, uThickness: { value: thickness },
        uGlow: { value: glow }, uTaper: { value: taper }, uSpread: { value: spread },
        uHueShift: { value: hueShift }, uIntensity: { value: intensity },
