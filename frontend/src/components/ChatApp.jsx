  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 flex min-h-0 relative">
        ...
        {/* Chat is always the surface. Autopilot / Priority / Planner / Brain
            open OVER it as a panel, so a glance at what's pending never costs
            you your place in the conversation. */}
        {view !== "chat" && (
          <div className="fixed inset-0 z-50 flex justify-end">
            ...
            />
            <div className="relative w-full max-w-2xl h-full bg-black border-l border-white/15 flex flex-col shadow-2xl">
              <div className="flex items-center justify-between px-5 py-3 border-b border-white/10 shrink-0">
                ...
                <button
                  onClick={() => setView("chat")}
                  className="text-white/45 hover:text-white text-sm px-2"
        ...
        {(
          <main className="flex-1 flex flex-col min-w-0">
            <WorkspaceBar onOpen={(v) => setView(v)} autopilotOn={user?.autopilot === true} />
            <Messages
              messages={messages}
              busy={busy}
