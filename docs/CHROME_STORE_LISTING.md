...
package: `dist-extension/agentfury-extension-v1.9.1.zip` (already built and
verified — manifest at the zip root as required).

> If you already have an item uploaded, this is now **v1.9.1** — upload the
...
- Click **New Item** → upload `dist-extension/agentfury-extension-v1.9.1.zip`
